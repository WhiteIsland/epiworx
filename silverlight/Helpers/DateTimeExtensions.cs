...
namespace Epiworx.Silverlight.Helpers
{
    public static class DateTimeExtensions
    {
        ...
        public static DateTime ToStartOfNextYear(this DateTime dateTime)
        {
            var startDate = DateTime.Parse("1/1/" + dateTime.Year).AddYears(1);
        ...
        public static DateTime ToStartOfNextMonth(this DateTime dateTime)
        {
            return dateTime.ToEndOfMonth().AddDays(1);
        }
