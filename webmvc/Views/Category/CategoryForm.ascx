...
<fieldset>
    <p class="span3">
        ...
        <span class="tip">This is the name of the category, this name must be unique, e.g. Bug.</span>
    </p>
    <div class="clear">
    </div>
    <p class="span3">
        ...
        <span class="tip">This is a detailed description of the category and it's purpose.</span>
    </p>
    <div class="clear">
    </div>
    <p class="span1">
        ...
        <span class="tip">Determines the order in which the category displays.</span>
    </p>
    <div class="clear">
    </div>
    <p class="span1">
